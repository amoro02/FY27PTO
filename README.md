...
Checklist:
1. In Vercel project settings, set the connected branch to your production branch (recommended: `codex/develop-internal-web-app-for-pto-management`).
...
Do this exactly:
1. In GitHub, keep one production branch (your single branch `codex/develop-internal-web-app-for-pto-management`) and ensure it contains commit `1ae3a31` or newer.
...
```bash
git checkout codex/develop-internal-web-app-for-pto-management
git push origin codex/develop-internal-web-app-for-pto-management --force-with-lease
```
...
- `codex/develop-internal-web-app-for-pto-management` = the only active branch for production.
